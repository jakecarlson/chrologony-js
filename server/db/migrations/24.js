...
Migrations.add({
    ...
    up: function() {
        Games.update(
            {},
            {
                $set: {name: null, password: null, private: true, ownerId: null, deletedAt: null},
                $unset: {roomId: 1},
            },
            {multi: true}
        );
    ...
    down: function() {
        ...
        Games.update({}, {$unset: {name: 1, password: 1, private: 1, ownerId: 1, deletedAt: 1, token: 1}}, {multi: true});
    },
